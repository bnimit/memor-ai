...
def test_proxy_benchmark_meets_release_gate(tmp_path):
    """Test that the proxy benchmark meets the release gate: ≥15% mean savings on tool-rich fixtures."""
...
def test_proxy_benchmark_individual_fixtures(tmp_path):
    ...
    expected_tool_rich = {"error_logs", "json_response", "openai_test_output", "database_logs"}
