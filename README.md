...
[![Tests](https://img.shields.io/badge/tests-1294%20passing-brightgreen.svg)]()
...
| A `pytest -v` run | **1,975 → 222 tokens** (88.8%) | 1 run of this repo's 1,294-test suite |
